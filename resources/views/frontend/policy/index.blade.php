...
<p>ShoesStore ("us", "we", or "our") operates the shoesstore.local.com website (the "Service").</p>
<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our
    Service and the choices you have associated with that data. Our Privacy Policy for ShoesStore is created with the
...
<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
    ...
    Privacy Policy have the same meanings as in our Terms and Conditions, accessible from shoesstore.local.com</p>
...
<h2>Use of Data</h2>
<p>ShoesStore uses the collected data for various purposes:</p>
<ul>
...
<p>If you are located outside Viet Nam and choose to provide information to us, please note that we transfer the data,
    including Personal Data, to Viet Nam and process it there.</p>
<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
    transfer.</p>
<p>ShoesStore will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
...
<p>ShoesStore may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of ShoesStore</li>
...
<ul>
    <li>By visiting this page on our website: shoesstore.local.com/contact</li>
</ul>
@endsection