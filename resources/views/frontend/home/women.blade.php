...
@section('title', trans('home.women_shoes', ['name' => $products[0]->category->name]))
@section('content')
...
<div class="row">
	...
	<div class="col-lg-9 tab-content">
		<div class="row">
			<div class="col-md-12">
				<h3 class="text-uppercase float-left mb-4">{{ trans('home.women_shoes', ['name' => $products[0]->category->name]) }} ({{ count($products) }})</h3>
